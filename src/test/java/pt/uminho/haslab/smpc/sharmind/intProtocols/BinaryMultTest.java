...
public class BinaryMultTest extends DoubleBatchProtocolTest {


    public BinaryMultTest(int[] firstValues, int[] secondValues) {
        super(1,firstValues, secondValues);
    }

    /* Overrides default */
    @Parameterized.Parameters
    public static Collection nbitsValues() {
        return ValuesGenerator.IntBinaryBatchValuesGenerator(100,100);
    }
    ...
    public int[] runProtocol(int[] firstShares, int[] secondShares, Player player) {
        ...
        return issf.multBit(firstShares, secondShares, player);
    }
    ...
    public void condition(BatchDbTest db1, BatchDbTest db2, BatchDbTest db3) {
        ...
        for(int i = 0; i < db1Results.length; i++){
            ...
            int results = dealer.unshareBit(shares);
