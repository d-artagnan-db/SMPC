...
public abstract class DoubleValueProtocolTest extends ProtocolTest {
  ...
  public List<DbTest> prepareDatabases(Players players) throws InvalidNumberOfBits, InvalidSecretValue {
    ...
    DbTest rdb0 = new Db ((SharemindSecret)secretOne.getSecretU1(p0), (SharemindSecret)secretTwo.getSecretU1(p0));
    DbTest rdb1 = new Db ((SharemindSecret)secretOne.getSecretU2(p1), (SharemindSecret)secretTwo.getSecretU2(p1));
    DbTest rdb2 = new Db ((SharemindSecret)secretOne.getSecretU3(p2), (SharemindSecret)secretTwo.getSecretU3(p2));
