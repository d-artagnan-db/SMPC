...
public class PrefixOrTest extends SingleValueProtocolTest {

	public PrefixOrTest(int nbits, BigInteger value) {
		super(nbits, value);
	}

	@Override
	public Secret runProtocol(Secret secret) {
		return ((SharemindBitVectorSecret) secret).prefixOr();
	}
